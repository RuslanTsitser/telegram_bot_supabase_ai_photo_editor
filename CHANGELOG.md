...
- Всего коммитов: 35
- Общее количество изменений: 2,200+ строк добавлено, 200+ строк удалено
- Основные файлы: `index.ts` (366 строк), `processImageGroup.ts` (174 строки), `onboarding.ts` (82 строки), `i18n.ts` (94 строки)
- Новые компоненты: система интернационализации, поддержка многоязычности, улучшенный онбординг
